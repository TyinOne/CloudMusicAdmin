  ...
  <div class="login-container">
    ...
    <div class="login-content">
      <div class="login-content-main">
        ...
        <div class="ipc-code">
          <a class="ipc-code-text" href="https://beian.miit.gov.cn" target="_blank">蜀ICP备2022011812号</a>
        </div>
      </div>
    </div>
  </div>
...
import Scan from '@renderer/views/login/components/scan.vue';
import {computed, reactive} from "vue";
import {useStore} from "@renderer/store";
import logoMini from '@renderer/assets/cloud_music.svg';
import loginIconTwo from '@renderer/assets/login-icon-two.svg';
